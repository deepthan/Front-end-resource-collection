...
|[JS日期对比](https://github.com/Wscats/Good-text-Share/issues/11)|JSONP参考文章:[json和jsonp](https://kb.cnblogs.com/page/139725/)[json详解](http://www.cnblogs.com/yuzhongwusan/archive/2012/12/11/2812849.html)[菜鸟教程jsonp](http://www.runoob.com/json/json-jsonp.html)|
...
| 好玩的动画效果[刘看山](https://liukanshan.zhihu.com/) | [缓动函数(依据贝赛尔曲线实现)](http://easings.net/zh-cn) |
...
| [查看本地分支对应远程哪个分支](https://github.com/deepthan/Front-end-resource-collection/issues/32) | [查看本地和远程有哪些分支](https://github.com/deepthan/Front-end-resource-collection/issues/33) | 
| [更改本地分支对应的远程分支](https://github.com/deepthan/Front-end-resource-collection/issues/34) |  | 
...
| 用法 | 用法 |
| --------- | --------- |
| [在npm发布自己的angular包](https://www.jianshu.com/p/ced79d48e353)| [代理](https://github.com/deepthan/Front-end-resource-collection/issues/27) |


| 报错解决 | 报错解决 |
| --------- | --------- |
| [ 关于npm 连接错误或者设置了代理](https://github.com/deepthan/Front-end-resource-collection/issues/26)|  |
...
| 书单 | 书单 |
| --------- | --------- |
| [成为一名优秀的Developer的书单](https://zhuanlan.zhihu.com/phodal/20436712) | [前端进阶书单](https://www.jianshu.com/p/3cf51d3dbb73)|
...
| --------- | --------- |
| [Google JavaScript Style Guide](https://google.github.io/styleguide/jsguide.html)  | [JavaScript Style Guide,star 66k](https://github.com/airbnb/javascript)  | 
| ES5风格指南：[英文版](https://github.com/airbnb/javascript/tree/es5-deprecated/es5)/ [中文版](https://github.com/sivan/javascript-style-guide/blob/master/es5/README.md) |  |
| ES6/ES2015风格指南[中文版](https://github.com/yuche/javascript)  |  React/JSX 编码规范: [英文版](https://github.com/airbnb/javascript/tree/master/react)/ [中文版](https://github.com/JasonBoy/javascript/tree/master/react) | 
